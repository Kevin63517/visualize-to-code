    ...
    <header className="bg-black text-white sticky top-0 z-50">
      <nav className="container mx-auto px-4 py-4">
        ...
        <div className="grid grid-cols-3 items-center">
          {/* Sección izquierda - menú hamburguesa en móvil */}
            ...
            <div className="hidden lg:flex space-x-8">
              ...
              <div className="relative group">
                <button className="flex items-center hover:text-gray-300 transition-colors">
                  Productos <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="ml-1"><polyline points="6 9 12 15 18 9"></polyline></svg>
                </button>
          ...
          {/* Sección derecha - redes sociales y carrito */}
