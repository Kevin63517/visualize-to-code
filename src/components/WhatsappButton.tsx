  ...
  return (
    ...
    >
      <div className="relative">
        {/* Burbuja de tooltip */}
        {isHovered && (
          <div className="absolute bottom-full right-0 mb-2 whitespace-nowrap bg-white text-gray-800 px-4 py-2 rounded-lg shadow-lg text-sm font-medium">
